 ...
 */
public class JsonStringMessageDecoder extends KeyedMessageDecoder<byte[], String, byte[], String> {
    ...
    public KeyedCamusWrapper<String, String> decode(byte[] key, byte[] message) {
        ...
        return new KeyedCamusWrapper<>(new String(key, Charsets.UTF_8), payloadString, timestamp);
    }
}
